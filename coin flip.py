...
#After a lot of research, Little Elephant came to know that most of the animals
#in the forest were showing less interest to play the multi-player games.
#Little Elephant had started to invent single player games,
...
#In the k-th round the player will flip the face of the all coins whose number
#is less than or equal to k.
#That is, the face of coin i will be reversed, from Head to Tail, or,
#from Tail to Head, for i ≤ k.

#Elephant needs to guess the total number of coins showing a particular face
#after playing N rounds. Elephant really becomes quite fond of this game COIN FLIP,
